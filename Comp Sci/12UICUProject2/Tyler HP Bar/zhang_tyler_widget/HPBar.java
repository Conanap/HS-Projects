 ...
 * The color of the bar is going to be adjusted(from green to red) basing on the current percentage of hp.
 * 
 * @author Tyler Zhang
 * @version Sept 2014
 */
public class HPBar extends Actor
{
     ...
     */
    public HPBar(int max, int current, boolean destroy)
    {
        bar = new GreenfootImage(CONTAIN_SIZE, CONTAIN_SIZE); // Initialize the GreenfootImage of the bar.
