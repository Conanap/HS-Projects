 ...
 * Game World.
 * 
 * @author (Albion, Roland, Marco, Jasper, Tyler ) 
...
public class Test extends World
{
    ...
    private boolean loadedWorld=false, mapLoaded=false,playerExist=true;
    private int [] [] map;
    ShopInv shopInv;
    private int shopDelay, repairDelay;
    private miniMap min;
    ...
    {    
        ...
        setPaintOrder(ReturnToMenu.class, GameOver.class,HoverText.class, HealthBar.class, DurationDisplay.class, StringDisplay.class, InventoryItem.class, 
            ShopItem.class, RepairSlot.class, TrashSlot.class, InventorySlot.class, Buttons.class, PlyrInv.class, ShopInv.class, SOS.class, miniMap.class,
            ToolbarSlot.class, ToolBar.class, Tools.class, Player.class, Block.class,Rope.class,Torch.class,Bomb.class, Building.class,worldGen.class);
    ...
    private void checkInventories() {
        if (Greenfoot.isKeyDown("control") && !shopInv.isShowing() && !player.getInventory().getRepairOpen()){
            player.toggleInventory();
        } else if (Greenfoot.isKeyDown("control") && !shopInv.isShowing() && player.getInventory().getRepairOpen()){
        ...
        if (Greenfoot.mouseClicked(repair) && player.shopInRange() && repairDelay >= 10){
            ...
            repairDelay = 0;
        } else if (Greenfoot.mouseClicked(repair) && repairDelay >= 10
        || !player.shopInRange() && repairDelay >= 10){
