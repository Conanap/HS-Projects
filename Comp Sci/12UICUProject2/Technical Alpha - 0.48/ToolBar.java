...
public class ToolBar extends Inventory
{
    ...
    public void setShowing(boolean showing){
        ...
        if (showing == false) {
            for (int i = 0; i < 5; i++) {
                if (itemArray[i] != null) itemArray[i].hideDisplay(true);
            }
            updateBar(-1,0);
        } 
        else
        {
            for (int i = 0; i < 5; i++) {
                if (itemArray[i] != null) itemArray[i].hideDisplay(false);
            }
    ...
    private void emptyInvSlots() {
        for (int i = 0; i < 5; i++) {
            if (itemArray[i] != null) {itemArray[i].clearDisplay(); getWorld().removeObject(itemArray[i]);}
    ...
    private void checkTool() {
        ...
        if (itemArray[curAction-1] != null) {
            if (itemArray[curAction-1].getID() == 20) {
                world.getPlayer().getPlayerArm().update(1,100);
                world.getPlayer().getPlayerArm().changeDig(true);
            } else if (itemArray[curAction-1].getID() == 21) {
                world.getPlayer().getPlayerArm().update(2,100);
                world.getPlayer().getPlayerArm().changeDig(true);
            } else if (itemArray[curAction-1].getID() == 22) {
                world.getPlayer().getPlayerArm().update(3,100);
                world.getPlayer().getPlayerArm().changeDig(true);
            } else if (itemArray[curAction-1].getID() == 23) {
                world.getPlayer().getPlayerArm().update(4,100);
                world.getPlayer().getPlayerArm().changeDig(true);
            } else if (itemArray[curAction-1].getID() == 24) {
                world.getPlayer().getPlayerArm().update(5,100);
                world.getPlayer().getPlayerArm().changeDig(true);
            } else if (itemArray[curAction-1].getID() == 25) {
                world.getPlayer().getPlayerArm().update(6,100);
                world.getPlayer().getPlayerArm().changeDig(true);
            } else if (itemArray[curAction-1].getID() == 26) {
                world.getPlayer().getPlayerArm().update(7,100);
                world.getPlayer().getPlayerArm().changeDig(true);
            } else if (itemArray[curAction-1].getID() == 27) {
                world.getPlayer().getPlayerArm().update(8,100);
                world.getPlayer().getPlayerArm().changeDig(true);
            } else if (itemArray[curAction-1].getID() == 0) {
                world.getPlayer().getPlayerArm().update(9,100);
                world.getPlayer().getPlayerArm().changeDig(false);
            } else if (itemArray[curAction-1].getID() == 1) {
                world.getPlayer().getPlayerArm().update(10,100);
                world.getPlayer().getPlayerArm().changeDig(false);
            } else if (itemArray[curAction-1].getID() == 2) {
                world.getPlayer().getPlayerArm().update(11,100);
                world.getPlayer().getPlayerArm().changeDig(false);
            } else if (itemArray[curAction-1].getID() == 28) {
                world.getPlayer().getPlayerArm().update(12,100);
                world.getPlayer().getPlayerArm().changeDig(false);
            } else if (itemArray[curAction-1].getID() == 29) {
                world.getPlayer().getPlayerArm().update(13,100);
                world.getPlayer().getPlayerArm().changeDig(false);
            } else if (itemArray[curAction-1].getID() == 30) {
                world.getPlayer().getPlayerArm().update(14,100);
                world.getPlayer().getPlayerArm().changeDig(false);
            } else if (itemArray[curAction-1].getID() == 31) {
                world.getPlayer().getPlayerArm().update(15,100);
                world.getPlayer().getPlayerArm().changeDig(false);
            }
        } else {
            world.getPlayer().getPlayerArm().update(0,100);
            world.getPlayer().getPlayerArm().changeDig(true);
        }
    }
}