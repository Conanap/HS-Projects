...
public class HoverText extends Actor
{
    ...
    public HoverText(int itemID)
    {
        switch(itemID)
        {
            ...
            case emerald_ingot:
            description.add("Emerald: This is famous because of");
            description.add("Pokemon more than anything.");
            break;
            ...
            description.add("pickaxe. Why won't you want gold?");
            break;
            ...
            case silver_drill:
            description.add("Don't worry, this is just a drill. A silver drill.");
            ...
            description.add("a diamond tail, but we stole it from Victor.");
            break;
        ...
        base= new GreenfootImage(238,description.size()*15);
        setImage(base);
        base.fillRect(0,0,238,base.getHeight());
        base.setTransparency(127);
        base.setColor(Color.WHITE);
        int y = 13;
        for(String description : description)
        {
            base.drawString(description, 8,y);
            y+=13;
        }
    }    
    //change
