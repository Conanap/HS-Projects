...
{ 
    ...
    /**
     * Actor, updates the bars and check if it's taking damage from zombies.
     */
    public void act(){
        checkZombies();
        checkFoodandWater();
    ...
    /**
     * determines what resource needs to be changed and how
     */
    ...
    /**
     * Check if zombies are here and apply damage in relation to the type of zombie
     */
    private void checkZombies()

    //Roland
    {
        int range = 80;//make a range to check around
        /**
         * the method creates lists of zombies, and checking if they are in the range of damage. It then takes damage based on the type of zombie.
         */
